...
if __name__=="__main__":
    data_dir = os.path.join("Data","manuscript_online")
    save_dir = os.path.join("temp","pos")
    neg_save_dir = os.path.join("temp","neg")
    ...
    for img_name in os.listdir(neg_save_dir):
        os.remove(os.path.join(neg_save_dir,img_name))
    """
